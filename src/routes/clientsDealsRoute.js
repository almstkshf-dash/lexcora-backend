...
router.get('/', authenticateToken, clientsDealsController.getAllClientsDeals);

// Get deals by client ID
router.get('/client/:clientId', authenticateToken, clientsDealsController.getClientDealsByClientId);
...
router.post('/', authenticateToken, clientsDealsController.createClientDeal);

// Update a client deal (no file upload needed - files are uploaded separately via /upload endpoint)
router.put('/:id', authenticateToken, clientsDealsController.updateClientDeal);

// Delete a client deal
router.delete('/:id', authenticateToken, clientsDealsController.deleteClientDeal);
